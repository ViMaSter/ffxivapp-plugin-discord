...
namespace FFXIVAPP.Plugin.Log.ChatHandler
{
    public class FFXIV
    {
        ...
        private readonly string ChatChannel = Properties.Settings.Default.FFXIV__ChannelID;
        ...
        public FFXIV(FFXIVAPP.IPluginInterface.IPluginHost host)
        {
            ...
            host.ConstantsUpdated += OnConstantsUpdated;
            host.CurrentPlayerUpdated += OnCurrentPlayerUpdated;
        ...
        {
            if (currentCharacter._characterName == e.CurrentPlayer.Name)
            {
                return;
            }

            currentCharacter._characterName = e.CurrentPlayer.Name;
        }

        private void OnConstantsUpdated(object sender, FFXIVAPP.IPluginInterface.Events.ConstantsEntityEvent e)
        {
            if (currentCharacter._worldName == e.ConstantsEntity.ServerName)
            {
                return;
            }

            currentCharacter._worldName = e.ConstantsEntity.ServerName;
        }
        ...
        private void OnChatMessageReceived(object sender, FFXIVAPP.IPluginInterface.Events.ChatLogItemEvent e)
        {
            ...
            if (e.ChatLogItem.Line.StartsWith(currentCharacter._characterName))
            {
                return;
            }
