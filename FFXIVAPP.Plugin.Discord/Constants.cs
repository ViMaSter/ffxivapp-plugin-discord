namespace FFXIVAPP.Plugin.Discord {
    ...
    public static class Constants {
        public const string LibraryPack = "pack://application:,,,/FFXIVAPP.Plugin.Discord;component/";
        ...
        public static XDocument XSettings {
            get {
                var file = Path.Combine(Common.Constants.PluginsSettingsPath, "FFXIVAPP.Plugin.Discord.xml");
                var legacyFile = "./Plugins/FFXIVAPP.Plugin.Discord/Settings.xml";
                if (_xSettings != null) {
                    return _xSettings;
                }
